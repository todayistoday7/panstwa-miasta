...
const LANGS = {
  pl: {
    ...
    pickCardTitle:     'Twoja kolej — wymyśl słowo',
    submitLabel:       'Start!',
  ...
  en: {
    ...
    pickCardTitle:     'Your turn — pick a word',
    submitLabel:       'Start!',
  ...
  de: {
    ...
    pickCardTitle:     'Du bist dran — wähle ein Wort',
    submitLabel:       'Start!',
    hintPlaceholder:   'Hinweis / Kategorie (optional)',
    hintStep:          'Hinweis hinzufügen',
    step1:             'Schritt 1',
    step2:             'Schritt 2',
    step3:             'Schritt 3',
    step3Label:        'Start',
  ...
  sv: {
    name:              '🇸🇪 SV',
    gameTitle:         'HÄNGA GUBBE',
    subtitle:          'Ordspel online · 2-10 spelare',
    ...
    leaveMsg:          'Spelet pågår. Är du säker?',
    ...
    youArePicker:      '🤫 DIN TUR — VÄLJ ETT ORD',
    theirTurnPick:     (n) => `🤔 ${n} väljer ett ord...`,
    youAreGuesser:     '🔤 GISSA BOKSTÄVERNA!',
    pickerWatching:    '👁 Du tittar — det är ditt ord',
    pickInstruction:   'Skriv in ordet att gissa:',
    pickCardTitle:     'Din tur — välj ett ord',
    submitLabel:       'Starta!',
    hintPlaceholder:   'Tips / Kategori (valfritt)',
    hintStep:          'Lägg till tips',
    step1:             'Steg 1',
    step2:             'Steg 2',
    step3:             'Steg 3',
    step3Label:        'Start',
    confirmWord:       '✓ Bekräfta ord',
    pickTip:           'Tips: Använd ett slumpmässigt ord från listan 👇',
    randomWord:        'Slumpa',
    guessWordBtn:      'Gissa!',
    fullGuessPlaceholder: 'Skriv hela ordet...',
    pickerWatchingText:'👁 Du tittar — se om de gissar rätt!',
    wrongCount:        (n, m) => `${n}/${m} fel`,
    wordWas:           'Ordet var:',
    youWonRound:       '🎉 Rätt gissat! +1 poäng',
    pickerWonRound:    (n) => `💀 ${n} vinner denna runda!`,
    youPickerWon:      '🎭 Ingen gissade rätt! +1 poäng för dig',
...
function applyTranslations() {
  const map = {
    ...
    'lbl-pick-card-title':  'pickCardTitle',
    'lbl-submit-label':     'submitLabel',
    'lbl-random-label':     'randomWord',
