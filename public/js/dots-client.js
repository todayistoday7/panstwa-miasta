...
const LANGS = {
  ...
  de: {
    ...
    gridSize:     'Rastergröße',     maxPlayers:  'Max. Spieler',
    ...
    demoCaption:  'Tippe auf eine Linie zwischen zwei Punkten um sie zu zeichnen',
  ...
  sv: {
    name: '🇸🇪 SV',
    gameTitle:    'PUNKTER & LINJER',
    subtitle:     'Online multiplayer · 2-4 spelare',
    ...
    gridSize:     'Rutnätsstorlek',  maxPlayers:  'Max spelare',
    ...
    shareRoom:    'Dela rum',
    demoCaption:  'Tryck på en linje mellan två punkter för att rita den',
