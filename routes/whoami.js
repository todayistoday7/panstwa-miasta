...
const CHARACTERS = {
  ...
  film: {
    ...
    {en:"Shrek",pl:"Shrek",de:"Shrek",sv:"Shrek",langs:["en", "pl", "de", "sv"]},
      {en:"Kevin McCallister",pl:"Kevin McCallister",de:"Kevin McCallister",sv:"Kevin McCallister",langs:["en","pl","de","sv"]},
      {en:"John McClane",pl:"John McClane",de:"John McClane",sv:"John McClane",langs:["en","pl","de","sv"]},
      {en:"Marty McFly",pl:"Marty McFly",de:"Marty McFly",sv:"Marty McFly",langs:["en","pl","de","sv"]},
      {en:"Terminator",pl:"Terminator",de:"Terminator",sv:"Terminator",langs:["en","pl","de","sv"]},
      {en:"Sarah Connor",pl:"Sarah Connor",de:"Sarah Connor",sv:"Sarah Connor",langs:["en","pl","de","sv"]},
      {en:"Clarice Starling",pl:"Clarice Starling",de:"Clarice Starling",sv:"Clarice Starling",langs:["en","pl","de","sv"]},
      {en:"Aladdin",pl:"Aladdin",de:"Aladdin",sv:"Aladdin",langs:["en","pl","de","sv"]},
      {en:"Genie",pl:"Dżin",de:"Dschinni",sv:"Anden",langs:["en","pl","de","sv"]},
      {en:"Catwoman",pl:"Kobieta-Kot",de:"Catwoman",sv:"Catwoman",langs:["en","pl","de","sv"]},
      {en:"Mrs Doubtfire",pl:"Pani Doubtfire",de:"Mrs Doubtfire",sv:"Mrs Doubtfire",langs:["en","pl","de","sv"]},
      {en:"Andy Davis",pl:"Andy Davis",de:"Andy Davis",sv:"Andy Davis",langs:["en","pl","de","sv"]},
      {en:"Mr Potato Head",pl:"Pan Bulwa",de:"Herr Kartoffelkopf",sv:"Potatismannen",langs:["en","pl","de","sv"]},
      {en:"Sidney Prescott",pl:"Sidney Prescott",de:"Sidney Prescott",sv:"Sidney Prescott",langs:["en","pl","de","sv"]},
      {en:"Jerry Maguire",pl:"Jerry Maguire",de:"Jerry Maguire",sv:"Jerry Maguire",langs:["en","pl","de","sv"]},
      {en:"Agent J",pl:"Agent J",de:"Agent J",sv:"Agent J",langs:["en","pl","de","sv"]},
      {en:"Agent K",pl:"Agent K",de:"Agent K",sv:"Agent K",langs:["en","pl","de","sv"]},
      {en:"Jack Dawson",pl:"Jack Dawson",de:"Jack Dawson",sv:"Jack Dawson",langs:["en","pl","de","sv"]},
      {en:"Rose DeWitt Bukater",pl:"Rose DeWitt Bukater",de:"Rose DeWitt Bukater",sv:"Rose DeWitt Bukater",langs:["en","pl","de","sv"]},
      {en:"Hercules",pl:"Herkules",de:"Herkules",sv:"Herkules",langs:["en","pl","de","sv"]},
      {en:"Mulan",pl:"Mulan",de:"Mulan",sv:"Mulan",langs:["en","pl","de","sv"]},
      {en:"Mushu",pl:"Mushu",de:"Mushu",sv:"Mushu",langs:["en","pl","de","sv"]},
      {en:"Blade",pl:"Blade",de:"Blade",sv:"Blade",langs:["en","pl","de","sv"]},
      {en:"Neo",pl:"Neo",de:"Neo",sv:"Neo",langs:["en","pl","de","sv"]},
      {en:"Morpheus",pl:"Morfeusz",de:"Morpheus",sv:"Morpheus",langs:["en","pl","de","sv"]},
      {en:"Trinity",pl:"Trinity",de:"Trinity",sv:"Trinity",langs:["en","pl","de","sv"]},
      {en:"Anakin Skywalker",pl:"Anakin Skywalker",de:"Anakin Skywalker",sv:"Anakin Skywalker",langs:["en","pl","de","sv"]},
      {en:"Maximus",pl:"Maximus",de:"Maximus",sv:"Maximus",langs:["en","pl","de","sv"]},
      {en:"Professor X",pl:"Profesor X",de:"Professor X",sv:"Professor X",langs:["en","pl","de","sv"]},
      {en:"Mystique",pl:"Mystique",de:"Mystique",sv:"Mystique",langs:["en","pl","de","sv"]},
      {en:"Lilo",pl:"Lilo",de:"Lilo",sv:"Lilo",langs:["en","pl","de","sv"]},
      {en:"Stitch",pl:"Stitch",de:"Stitch",sv:"Stitch",langs:["en","pl","de","sv"]},
      {en:"Will Turner",pl:"Will Turner",de:"Will Turner",sv:"Will Turner",langs:["en","pl","de","sv"]},
      {en:"Elizabeth Swann",pl:"Elizabeth Swann",de:"Elizabeth Swann",sv:"Elizabeth Swann",langs:["en","pl","de","sv"]},
      {en:"Mr Incredible",pl:"Pan Niesamowity",de:"Mr. Unglaublich",sv:"Mr Incredible",langs:["en","pl","de","sv"]},
      {en:"Alex the Lion",pl:"Alex Lew",de:"Alex der Löwe",sv:"Alex Lejonet",langs:["en","pl","de","sv"]},
      ...
      {en:"Po",pl:"Po",de:"Po",sv:"Po",langs:["en","pl","de","sv"]},
      {en:"Jake Sully",pl:"Jake Sully",de:"Jake Sully",sv:"Jake Sully",langs:["en","pl","de","sv"]},
      {en:"Neytiri",pl:"Neytiri",de:"Neytiri",sv:"Neytiri",langs:["en","pl","de","sv"]},
      {en:"Alan (Hangover)",pl:"Alan",de:"Alan",sv:"Alan",langs:["en","pl","de","sv"]},
      {en:"Gru",pl:"Gru",de:"Gru",sv:"Gru",langs:["en","pl","de","sv"]},
      {en:"Toothless",pl:"Szczerbatek",de:"Ohnezahn",sv:"Tandlöse",langs:["en","pl","de","sv"]},
      {en:"Hiccup",pl:"Czkawka",de:"Hicks",sv:"Hicke",langs:["en","pl","de","sv"]},
      {en:"Anna",pl:"Anna",de:"Anna",sv:"Anna",langs:["en","pl","de","sv"]},
      {en:"Olaf",pl:"Olaf",de:"Olaf",sv:"Olaf",langs:["en","pl","de","sv"]},
      {en:"Star Lord",pl:"Star-Lord",de:"Star-Lord",sv:"Star-Lord",langs:["en","pl","de","sv"]},
      {en:"Groot",pl:"Groot",de:"Groot",sv:"Groot",langs:["en","pl","de","sv"]},
      {en:"Rocket",pl:"Rocket",de:"Rocket",sv:"Rocket",langs:["en","pl","de","sv"]},
      {en:"Maleficent",pl:"Czarownica",de:"Maleficent",sv:"Maleficent",langs:["en","pl","de","sv"]},
      {en:"Emmet (LEGO)",pl:"Emmet",de:"Emmet",sv:"Emmet",langs:["en","pl","de","sv"]},
      {en:"Rey",pl:"Rey",de:"Rey",sv:"Rey",langs:["en","pl","de","sv"]},
      {en:"BB-8",pl:"BB-8",de:"BB-8",sv:"BB-8",langs:["en","pl","de","sv"]},
      {en:"Minions",pl:"Minionki",de:"Minions",sv:"Minions",langs:["en","pl","de","sv"]},
      {en:"Dom Toretto",pl:"Dom Toretto",de:"Dom Toretto",sv:"Dom Toretto",langs:["en","pl","de","sv"]},
      {en:"Moana",pl:"Moana",de:"Moana",sv:"Moana",langs:["en","pl","de","sv"]},
      {en:"Doctor Strange",pl:"Doktor Strange",de:"Doctor Strange",sv:"Doctor Strange",langs:["en","pl","de","sv"]},
      {en:"Pennywise",pl:"Pennywise",de:"Pennywise",sv:"Pennywise",langs:["en","pl","de","sv"]},
      {en:"Aquaman",pl:"Aquaman",de:"Aquaman",sv:"Aquaman",langs:["en","pl","de","sv"]},
      {en:"Sonic",pl:"Sonic",de:"Sonic",sv:"Sonic",langs:["en","pl","de","sv"]},
      {en:"Scooby Doo",pl:"Scooby Doo",de:"Scooby Doo",sv:"Scooby Doo",langs:["en","pl","de","sv"]},
      {en:"Mario",pl:"Mario",de:"Mario",sv:"Mario",langs:["en","pl","de","sv"]},
      {en:"Joy (Inside Out)",pl:"Radość",de:"Freude",sv:"Glädje",langs:["en","pl","de","sv"]},
      {en:"Lord Business",pl:"Lord Business",de:"Lord Business",sv:"Lord Business",langs:["en","pl","de","sv"]},
      {en:"Lord Farquaad",pl:"Lord Farquaad",de:"Lord Farquaad",sv:"Lord Farquaad",langs:["en","pl","de","sv"]},
      {en:"Oogway",pl:"Oogway",de:"Oogway",sv:"Oogway",langs:["en","pl","de","sv"]}
    ],
    medium: [
    ...
    {en:"John Wick",pl:"John Wick",de:"John Wick",sv:"John Wick",langs:["en", "pl", "de", "sv"]},
      {en:"Jasmine",pl:"Jasmin",de:"Jasmin",sv:"Jasmin",langs:["en","pl","de","sv"]},
      {en:"Jafar",pl:"Dżafar",de:"Jafar",sv:"Jafar",langs:["en","pl","de","sv"]},
      {en:"Penguin",pl:"Pingwin",de:"Pinguin",sv:"Pingvinen",langs:["en","pl","de","sv"]},
      {en:"Robin Hood",pl:"Robin Hood",de:"Robin Hood",sv:"Robin Hood",langs:["en","pl","de","sv"]},
      {en:"Jules Winnfield",pl:"Jules Winnfield",de:"Jules Winnfield",sv:"Jules Winnfield",langs:["en","pl","de","sv"]},
      {en:"Vincent Vega",pl:"Vincent Vega",de:"Vincent Vega",sv:"Vincent Vega",langs:["en","pl","de","sv"]},
      {en:"Dr Evil",pl:"Doktor Zło",de:"Dr. Evil",sv:"Dr Evil",langs:["en","pl","de","sv"]},
      {en:"Megara",pl:"Megara",de:"Megara",sv:"Megara",langs:["en","pl","de","sv"]},
      {en:"Walter Sobchak",pl:"Walter Sobchak",de:"Walter Sobchak",sv:"Walter Sobchak",langs:["en","pl","de","sv"]},
      {en:"Captain Miller",pl:"Kapitan Miller",de:"Captain Miller",sv:"Captain Miller",langs:["en","pl","de","sv"]},
      {en:"Agent Smith",pl:"Agent Smith",de:"Agent Smith",sv:"Agent Smith",langs:["en","pl","de","sv"]},
      {en:"Obi Wan Kenobi",pl:"Obi-Wan Kenobi",de:"Obi-Wan Kenobi",sv:"Obi-Wan Kenobi",langs:["en","pl","de","sv"]},
      {en:"Magneto",pl:"Magneto",de:"Magneto",sv:"Magneto",langs:["en","pl","de","sv"]},
      {en:"Storm",pl:"Storm",de:"Storm",sv:"Storm",langs:["en","pl","de","sv"]},
      {en:"Hagrid",pl:"Hagrid",de:"Hagrid",sv:"Hagrid",langs:["en","pl","de","sv"]},
      {en:"Mary Jane Watson",pl:"Mary Jane Watson",de:"Mary Jane Watson",sv:"Mary Jane Watson",langs:["en","pl","de","sv"]},
      {en:"Samwise Gamgee",pl:"Samwise Gamgee",de:"Samwise Gamgee",sv:"Samwise Gamgee",langs:["en","pl","de","sv"]},
      {en:"Lucius Malfoy",pl:"Lucjusz Malfoy",de:"Lucius Malfoy",sv:"Lucius Malfoy",langs:["en","pl","de","sv"]},
      {en:"Barbossa",pl:"Barbossa",de:"Barbossa",sv:"Barbossa",langs:["en","pl","de","sv"]},
      {en:"Violet Parr",pl:"Violet Parr",de:"Violetta Parr",sv:"Violet Parr",langs:["en","pl","de","sv"]},
      {en:"Dash Parr",pl:"Dash Parr",de:"Dash Parr",sv:"Dash Parr",langs:["en","pl","de","sv"]},
      {en:"Astrid",pl:"Astrid",de:"Astrid",sv:"Astrid",langs:["en","pl","de","sv"]},
      {en:"Tigress",pl:"Tygrysica",de:"Tigerin",sv:"Tigrinna",langs:["en","pl","de","sv"]},
      {en:"Harvey Dent",pl:"Harvey Dent",de:"Harvey Dent",sv:"Harvey Dent",langs:["en","pl","de","sv"]},
      {en:"EVE",pl:"EVE",de:"EVE",sv:"EVE",langs:["en","pl","de","sv"]},
      {en:"Master Shifu",pl:"Mistrz Shifu",de:"Meister Shifu",sv:"Mästare Shifu",langs:["en","pl","de","sv"]},
      {en:"Spock",pl:"Spock",de:"Spock",sv:"Spock",langs:["en","pl","de","sv"]},
      {en:"Lotso",pl:"Lotso",de:"Lotso",sv:"Lotso",langs:["en","pl","de","sv"]},
      {en:"Odin",pl:"Odyn",de:"Odin",sv:"Oden",langs:["en","pl","de","sv"]},
      {en:"Black Widow",pl:"Czarna Wdowa",de:"Black Widow",sv:"Black Widow",langs:["en","pl","de","sv"]},
      {en:"Hawkeye",pl:"Hawkeye",de:"Hawkeye",sv:"Hawkeye",langs:["en","pl","de","sv"]},
      {en:"Kristoff",pl:"Kristoff",de:"Kristoff",sv:"Kristoff",langs:["en","pl","de","sv"]},
      {en:"Hans",pl:"Hans",de:"Hans",sv:"Hans",langs:["en","pl","de","sv"]},
      {en:"Lois Lane",pl:"Lois Lane",de:"Lois Lane",sv:"Lois Lane",langs:["en","pl","de","sv"]},
      {en:"General Zod",pl:"Generał Zod",de:"General Zod",sv:"General Zod",langs:["en","pl","de","sv"]},
      {en:"Gamora",pl:"Gamora",de:"Gamora",sv:"Gamora",langs:["en","pl","de","sv"]},
      {en:"Drax",pl:"Drax",de:"Drax",sv:"Drax",langs:["en","pl","de","sv"]},
      {en:"Wyldstyle",pl:"Wyldstyle",de:"Wyldstyle",sv:"Wyldstyle",langs:["en","pl","de","sv"]},
      {en:"Aurora",pl:"Aurora",de:"Aurora",sv:"Aurora",langs:["en","pl","de","sv"]},
      {en:"Finn (Star Wars)",pl:"Finn",de:"Finn",sv:"Finn",langs:["en","pl","de","sv"]},
      {en:"Poe Dameron",pl:"Poe Dameron",de:"Poe Dameron",sv:"Poe Dameron",langs:["en","pl","de","sv"]},
      {en:"Maui",pl:"Maui",de:"Maui",sv:"Maui",langs:["en","pl","de","sv"]},
      {en:"Valkyrie",pl:"Walkiria",de:"Walküre",sv:"Valkyria",langs:["en","pl","de","sv"]},
      {en:"Hela",pl:"Hela",de:"Hela",sv:"Hela",langs:["en","pl","de","sv"]},
      {en:"Shuri",pl:"Shuri",de:"Shuri",sv:"Shuri",langs:["en","pl","de","sv"]},
      {en:"Killmonger",pl:"Killmonger",de:"Killmonger",sv:"Killmonger",langs:["en","pl","de","sv"]},
      {en:"Mera",pl:"Mera",de:"Mera",sv:"Mera",langs:["en","pl","de","sv"]},
      {en:"Captain Marvel",pl:"Kapitan Marvel",de:"Captain Marvel",sv:"Captain Marvel",langs:["en","pl","de","sv"]},
      {en:"Mysterio",pl:"Mysterio",de:"Mysterio",sv:"Mysterio",langs:["en","pl","de","sv"]},
      {en:"Scar (Lion King)",pl:"Skaza",de:"Scar",sv:"Scar",langs:["en","pl","de","sv"]},
      {en:"Dr Robotnik",pl:"Doktor Robotnik",de:"Dr. Robotnik",sv:"Dr Robotnik",langs:["en","pl","de","sv"]},
      {en:"Peach",pl:"Księżniczka Peach",de:"Prinzessin Peach",sv:"Prinsessan Peach",langs:["en","pl","de","sv"]},
      {en:"Bowser",pl:"Bowser",de:"Bowser",sv:"Bowser",langs:["en","pl","de","sv"]},
      {en:"Anxiety (Inside Out 2)",pl:"Lęk",de:"Angst",sv:"Ångest",langs:["en","pl","de","sv"]},
      {en:"Megamind",pl:"Megamind",de:"Megamind",sv:"Megamind",langs:["en","pl","de","sv"]},
      {en:"Loki",pl:"Loki",de:"Loki",sv:"Loki",langs:["en","pl","de","sv"]}
    ],
    hard: [
    ...
    {en:"Wars i Sawa",pl:"Wars i Sawa",de:"Wars i Sawa",sv:"Wars i Sawa",langs:["pl"]},
      {en:"Boromir",pl:"Boromir",de:"Boromir",sv:"Boromir",langs:["en","pl","de","sv"]},
      {en:"Syndrome",pl:"Syndrom",de:"Syndrom",sv:"Syndrom",langs:["en","pl","de","sv"]},
      {en:"Bellatrix Lestrange",pl:"Bellatrix Lestrange",de:"Bellatrix Lestrange",sv:"Bellatrix Lestrange",langs:["en","pl","de","sv"]},
      {en:"Nebula",pl:"Nebula",de:"Nebula",sv:"Nebula",langs:["en","pl","de","sv"]},
      {en:"Yondu",pl:"Yondu",de:"Yondu",sv:"Yondu",langs:["en","pl","de","sv"]},
      {en:"Ultron",pl:"Ultron",de:"Ultron",sv:"Ultron",langs:["en","pl","de","sv"]},
      {en:"Nick Fury",pl:"Nick Fury",de:"Nick Fury",sv:"Nick Fury",langs:["en","pl","de","sv"]},
      {en:"Haymitch",pl:"Haymitch",de:"Haymitch",sv:"Haymitch",langs:["en","pl","de","sv"]},
      {en:"Pepper Potts",pl:"Pepper Potts",de:"Pepper Potts",sv:"Pepper Potts",langs:["en","pl","de","sv"]},
      {en:"Davy Jones",pl:"Davy Jones",de:"Davy Jones",sv:"Davy Jones",langs:["en","pl","de","sv"]},
      {en:"Black Adam",pl:"Czarny Adam",de:"Black Adam",sv:"Black Adam",langs:["en","pl","de","sv"]},
      {en:"Wario",pl:"Wario",de:"Wario",sv:"Wario",langs:["en","pl","de","sv"]},
      {en:"Luigi",pl:"Luigi",de:"Luigi",sv:"Luigi",langs:["en","pl","de","sv"]},
      {en:"Toad (Nintendo)",pl:"Toad",de:"Toad",sv:"Toad",langs:["en","pl","de","sv"]},
      {en:"Scarlet Witch",pl:"Szkarłatna Wiedźma",de:"Scharlachrote Hexe",sv:"Scarlet Witch",langs:["en","pl","de","sv"]},
      {en:"Wong",pl:"Wong",de:"Wong",sv:"Wong",langs:["en","pl","de","sv"]},
      {en:"Doc Ock",pl:"Doktor Octopus",de:"Doctor Octopus",sv:"Doctor Octopus",langs:["en","pl","de","sv"]}
    ],
  },
  history: {
    easy: [
